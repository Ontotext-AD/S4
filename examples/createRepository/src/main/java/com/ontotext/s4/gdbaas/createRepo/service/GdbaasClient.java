...
public class GdbaasClient {
	...
	public GdbaasClient(String userId,String dbaasName,String keyId,String password){
	...
	private URI generateRepositoryEndpointUrl() throws URISyntaxException {
		...
		return new URI("https://rdf.s4.ontotext.com/"+userId+"/"+dbaasName+"/repositories/");
	}
	 ...
	 */
	public String createRepository(CreateRepositoryRequest repositoryInfo) throws JsonProcessingException, URISyntaxException{
		ObjectMapper mapper=new ObjectMapper();
		String message=mapper.writeValueAsString(repositoryInfo);
		HttpEntityEnclosingRequestBase put = new HttpPut(generateRepositoryEndpointUrl());
		return processRequest(message, APPLICATION_JSON_HEADER, APPLICATION_JSON_HEADER,put,APPLICATION_JSON_HEADER,APPLICATION_JSON_HEADER);
	}
	 ...
	 * @throws URISyntaxException
	 */
	public String deleteRepository(String repositoryId) throws URISyntaxException{
		HttpRequestBase put = new HttpDelete(generateRepositoryEndpointUrl()+repositoryId);
		return processRequest("", APPLICATION_JSON_HEADER, APPLICATION_JSON_HEADER,put,APPLICATION_JSON_HEADER,APPLICATION_JSON_HEADER);
	}
	 ...
	 * @throws URISyntaxException
	 */
	public String checkRepository(String repositoryId) throws URISyntaxException {
		String message="query=select%20*%20%7B%3Fs%20%3Fp%20%3Fo%7D%20limit%201";
		HttpEntityEnclosingRequestBase put = new HttpPost(generateRepositoryEndpointUrl()+repositoryId);
		return processRequest(message, APPLICATION_JSON_HEADER, APPLICATION_JSON_HEADER,put,SPARQL_CONTENT_TYPE,SPARQL_ACCEPT_HEADER);
		
	}
	
	public void uploadFile(String repositoryId,String baseURI,String pathToTheFile) throws Exception{
		RemoteRepositoryManager manager = RemoteRepositoryManager.getInstance("https://rdf.s4.ontotext.com/"+userId+"/"+dbaasName, keyId, password);
	 ...
	 * @throws URISyntaxException 
	 */
	private String processRequest(String message, String acceptType,String contentType,HttpRequestBase request,String contentTypeHeader,String acceptTypeHeader) throws URISyntaxException {
		...
		if(request instanceof HttpEntityEnclosingRequestBase){
		 ...
		 ((HttpEntityEnclosingRequestBase)request).setEntity(new StringEntity(message, Charset.forName("UTF-8")));
		}
