 ...
 */
s4App.service('sendCurrentPageToPipeLine', ["$q", function($q){
    ...
    var sendCurrentPageToPipeLine = function(selectedPipeLine, selectedTextFromUser) {
        var configObj = {};
        var deferred = $q.defer();

        configObj['eventId'] = buildEventId();
        configObj['data'] = selectedPipeLine;
        configObj['selectedTextFromUser'] = selectedTextFromUser;
