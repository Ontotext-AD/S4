 ...
 * @generated */
public class Work_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.types.news.Work");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.types.news.Work");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.types.news.Work");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.types.news.Work");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.types.news.Work");
  ...
  public String getSublcasses(int addr) {
      ...
      jcas.throwFeatMissing("sublcasses", "com.ontotext.s4.api.types.news.Work");
  ...
  public String getPreferredLabel(int addr) {
      ...
      jcas.throwFeatMissing("preferredLabel", "com.ontotext.s4.api.types.news.Work");
