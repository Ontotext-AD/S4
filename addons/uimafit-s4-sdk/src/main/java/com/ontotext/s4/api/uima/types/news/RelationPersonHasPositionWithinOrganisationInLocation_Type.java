 ...
 * @generated */
public class RelationPersonHasPositionWithinOrganisationInLocation_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (RelationPersonHasPositionWithinOrganisationInLocation_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = RelationPersonHasPositionWithinOrganisationInLocation_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new RelationPersonHasPositionWithinOrganisationInLocation(addr, RelationPersonHasPositionWithinOrganisationInLocation_Type.this);
  			   RelationPersonHasPositionWithinOrganisationInLocation_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new RelationPersonHasPositionWithinOrganisationInLocation(addr, RelationPersonHasPositionWithinOrganisationInLocation_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = RelationPersonHasPositionWithinOrganisationInLocation.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getOrganization1Str(int addr) {
      ...
      jcas.throwFeatMissing("organization1Str", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getOrganizationUri(int addr) {
      ...
      jcas.throwFeatMissing("organizationUri", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getOrganization1Uri(int addr) {
      ...
      jcas.throwFeatMissing("organization1Uri", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getRelType(int addr) {
      ...
      jcas.throwFeatMissing("relType", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  public String getOrganizationStr(int addr) {
      ...
      jcas.throwFeatMissing("organizationStr", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinOrganisationInLocation");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public RelationPersonHasPositionWithinOrganisationInLocation_Type(JCas jcas, Type casType) {
    super(jcas, casType);
