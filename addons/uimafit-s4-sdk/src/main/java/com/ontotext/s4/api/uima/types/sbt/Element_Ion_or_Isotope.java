  ...
  */  
  ...
  public String getString() {
    if (Element_Ion_or_Isotope_Type.featOkTst && ((Element_Ion_or_Isotope_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Element_Ion_or_Isotope");
  ...
  public String getClass_feature() {
    if (Element_Ion_or_Isotope_Type.featOkTst && ((Element_Ion_or_Isotope_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Element_Ion_or_Isotope");
  ...
  public String getInst() {
    if (Element_Ion_or_Isotope_Type.featOkTst && ((Element_Ion_or_Isotope_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Element_Ion_or_Isotope");
  ...
  public String getType_feature() {
    if (Element_Ion_or_Isotope_Type.featOkTst && ((Element_Ion_or_Isotope_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Element_Ion_or_Isotope");
