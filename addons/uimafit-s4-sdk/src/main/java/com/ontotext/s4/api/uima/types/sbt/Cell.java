  ...
  */  
  ...
  public String getString() {
    if (Cell_Type.featOkTst && ((Cell_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Cell");
  ...
  public String getClass_feature() {
    if (Cell_Type.featOkTst && ((Cell_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Cell");
  ...
  public String getInst() {
    if (Cell_Type.featOkTst && ((Cell_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Cell");
  ...
  public String getType_feature() {
    if (Cell_Type.featOkTst && ((Cell_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Cell");
