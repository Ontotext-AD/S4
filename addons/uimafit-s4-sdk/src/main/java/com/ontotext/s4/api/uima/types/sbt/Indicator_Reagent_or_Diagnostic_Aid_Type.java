 ...
 * @generated */
public class Indicator_Reagent_or_Diagnostic_Aid_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Indicator_Reagent_or_Diagnostic_Aid_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Indicator_Reagent_or_Diagnostic_Aid_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Indicator_Reagent_or_Diagnostic_Aid(addr, Indicator_Reagent_or_Diagnostic_Aid_Type.this);
  			   Indicator_Reagent_or_Diagnostic_Aid_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Indicator_Reagent_or_Diagnostic_Aid(addr, Indicator_Reagent_or_Diagnostic_Aid_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Indicator_Reagent_or_Diagnostic_Aid.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Indicator_Reagent_or_Diagnostic_Aid");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Indicator_Reagent_or_Diagnostic_Aid");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Indicator_Reagent_or_Diagnostic_Aid");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Indicator_Reagent_or_Diagnostic_Aid");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Indicator_Reagent_or_Diagnostic_Aid");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Indicator_Reagent_or_Diagnostic_Aid_Type(JCas jcas, Type casType) {
    super(jcas, casType);
