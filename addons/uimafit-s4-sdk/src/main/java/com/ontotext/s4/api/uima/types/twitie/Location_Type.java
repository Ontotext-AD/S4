...
public class Location_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getRule1(int addr) {
      ...
      jcas.throwFeatMissing("rule1", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getRule2(int addr) {
      ...
      jcas.throwFeatMissing("rule2", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getKind(int addr) {
      ...
      jcas.throwFeatMissing("kind", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getLength(int addr) {
      ...
      jcas.throwFeatMissing("length", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getReplaced(int addr) {
      ...
      jcas.throwFeatMissing("replaced", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getUser(int addr) {
      ...
      jcas.throwFeatMissing("user", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
  ...
  public String getNormalized(int addr) {
      ...
      jcas.throwFeatMissing("normalized", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.Location");
