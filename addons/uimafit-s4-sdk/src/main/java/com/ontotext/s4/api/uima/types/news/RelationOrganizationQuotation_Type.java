 ...
 * @generated */
public class RelationOrganizationQuotation_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (RelationOrganizationQuotation_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = RelationOrganizationQuotation_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new RelationOrganizationQuotation(addr, RelationOrganizationQuotation_Type.this);
  			   RelationOrganizationQuotation_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new RelationOrganizationQuotation(addr, RelationOrganizationQuotation_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = RelationOrganizationQuotation.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getOrganization1Str(int addr) {
      ...
      jcas.throwFeatMissing("organization1Str", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getOrganizationUri(int addr) {
      ...
      jcas.throwFeatMissing("organizationUri", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getOrganization1Uri(int addr) {
      ...
      jcas.throwFeatMissing("organization1Uri", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getRelType(int addr) {
      ...
      jcas.throwFeatMissing("relType", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getOrganizationStr(int addr) {
      ...
      jcas.throwFeatMissing("organizationStr", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getQuotationStr(int addr) {
      ...
      jcas.throwFeatMissing("quotationStr", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getAbbrevUri(int addr) {
      ...
      jcas.throwFeatMissing("abbrevUri", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  public String getAbbrevStr(int addr) {
      ...
      jcas.throwFeatMissing("abbrevStr", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.news.RelationOrganizationQuotation");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public RelationOrganizationQuotation_Type(JCas jcas, Type casType) {
    super(jcas, casType);
