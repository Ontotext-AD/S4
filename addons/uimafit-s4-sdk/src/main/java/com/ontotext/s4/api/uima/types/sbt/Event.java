...
/** Automatically generated type for Event
...
public class Event extends Annotation {
  ...
  */  
  ...
  /** getter for string - gets Feature <string> for type <Event>
   * @generated
   * @return value of the feature 
   */
  public String getString() {
    if (Event_Type.featOkTst && ((Event_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Event");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Event_Type)jcasType).casFeatCode_string);}
    
  /** setter for string - sets Feature <string> for type <Event> 
   * @generated
  ...
  /** getter for class_feature - gets Feature <class_feature> for type <Event>
   * @generated
   * @return value of the feature 
   */
  public String getClass_feature() {
    if (Event_Type.featOkTst && ((Event_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Event");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Event_Type)jcasType).casFeatCode_class_feature);}
    
  /** setter for class_feature - sets Feature <class_feature> for type <Event> 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for inst - gets Feature <inst> for type <Event>
   * @generated
   * @return value of the feature 
   */
  public String getInst() {
    if (Event_Type.featOkTst && ((Event_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Event");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Event_Type)jcasType).casFeatCode_inst);}
    
  /** setter for inst - sets Feature <inst> for type <Event> 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for type_feature - gets Feature <type_feature> for type <Event>
   * @generated
   * @return value of the feature 
   */
  public String getType_feature() {
    if (Event_Type.featOkTst && ((Event_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Event");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Event_Type)jcasType).casFeatCode_type_feature);}
    
  /** setter for type_feature - sets Feature <type_feature> for type <Event> 
   * @generated
   * @param v value to set into the feature 
   */
