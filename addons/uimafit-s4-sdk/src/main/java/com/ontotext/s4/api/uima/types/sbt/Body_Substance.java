  ...
  */  
  ...
  public String getString() {
    if (Body_Substance_Type.featOkTst && ((Body_Substance_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Body_Substance");
  ...
  public String getClass_feature() {
    if (Body_Substance_Type.featOkTst && ((Body_Substance_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Body_Substance");
  ...
  public String getInst() {
    if (Body_Substance_Type.featOkTst && ((Body_Substance_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Body_Substance");
  ...
  public String getType_feature() {
    if (Body_Substance_Type.featOkTst && ((Body_Substance_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Body_Substance");
