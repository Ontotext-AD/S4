 ...
 * @generated */
public class UserID_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (UserID_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = UserID_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new UserID(addr, UserID_Type.this);
  			   UserID_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new UserID(addr, UserID_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = UserID.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getLength(int addr) {
      ...
      jcas.throwFeatMissing("length", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getReplaced(int addr) {
      ...
      jcas.throwFeatMissing("replaced", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getUser(int addr) {
      ...
      jcas.throwFeatMissing("user", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getKind(int addr) {
      ...
      jcas.throwFeatMissing("kind", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getRule1(int addr) {
      ...
      jcas.throwFeatMissing("rule1", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  public String getRule2(int addr) {
      ...
      jcas.throwFeatMissing("rule2", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.twitie.UserID");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public UserID_Type(JCas jcas, Type casType) {
    super(jcas, casType);
