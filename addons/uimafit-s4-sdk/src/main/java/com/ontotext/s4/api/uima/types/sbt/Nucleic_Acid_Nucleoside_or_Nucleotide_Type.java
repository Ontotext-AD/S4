 ...
 * @generated */
public class Nucleic_Acid_Nucleoside_or_Nucleotide_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Nucleic_Acid_Nucleoside_or_Nucleotide_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Nucleic_Acid_Nucleoside_or_Nucleotide_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Nucleic_Acid_Nucleoside_or_Nucleotide(addr, Nucleic_Acid_Nucleoside_or_Nucleotide_Type.this);
  			   Nucleic_Acid_Nucleoside_or_Nucleotide_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Nucleic_Acid_Nucleoside_or_Nucleotide(addr, Nucleic_Acid_Nucleoside_or_Nucleotide_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Nucleic_Acid_Nucleoside_or_Nucleotide.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Nucleic_Acid_Nucleoside_or_Nucleotide");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Nucleic_Acid_Nucleoside_or_Nucleotide");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Nucleic_Acid_Nucleoside_or_Nucleotide");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Nucleic_Acid_Nucleoside_or_Nucleotide");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Nucleic_Acid_Nucleoside_or_Nucleotide");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Nucleic_Acid_Nucleoside_or_Nucleotide_Type(JCas jcas, Type casType) {
    super(jcas, casType);
