 ...
 * @generated */
public class Neuroreactive_Substance_or_Biogenic_Amine_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Neuroreactive_Substance_or_Biogenic_Amine_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Neuroreactive_Substance_or_Biogenic_Amine_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Neuroreactive_Substance_or_Biogenic_Amine(addr, Neuroreactive_Substance_or_Biogenic_Amine_Type.this);
  			   Neuroreactive_Substance_or_Biogenic_Amine_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Neuroreactive_Substance_or_Biogenic_Amine(addr, Neuroreactive_Substance_or_Biogenic_Amine_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Neuroreactive_Substance_or_Biogenic_Amine.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Neuroreactive_Substance_or_Biogenic_Amine");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Neuroreactive_Substance_or_Biogenic_Amine");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Neuroreactive_Substance_or_Biogenic_Amine");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Neuroreactive_Substance_or_Biogenic_Amine");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Neuroreactive_Substance_or_Biogenic_Amine");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Neuroreactive_Substance_or_Biogenic_Amine_Type(JCas jcas, Type casType) {
    super(jcas, casType);
