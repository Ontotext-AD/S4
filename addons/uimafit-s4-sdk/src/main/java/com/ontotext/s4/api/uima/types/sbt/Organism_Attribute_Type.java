 ...
 * @generated */
public class Organism_Attribute_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Organism_Attribute_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Organism_Attribute_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Organism_Attribute(addr, Organism_Attribute_Type.this);
  			   Organism_Attribute_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Organism_Attribute(addr, Organism_Attribute_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Organism_Attribute.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Organism_Attribute");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Organism_Attribute");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Organism_Attribute");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Organism_Attribute");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Organism_Attribute");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Organism_Attribute_Type(JCas jcas, Type casType) {
    super(jcas, casType);
