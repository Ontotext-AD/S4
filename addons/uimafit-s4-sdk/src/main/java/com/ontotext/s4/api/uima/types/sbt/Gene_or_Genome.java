  ...
  */  
  ...
  public String getString() {
    if (Gene_or_Genome_Type.featOkTst && ((Gene_or_Genome_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Gene_or_Genome");
  ...
  public String getClass_feature() {
    if (Gene_or_Genome_Type.featOkTst && ((Gene_or_Genome_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Gene_or_Genome");
  ...
  public String getInst() {
    if (Gene_or_Genome_Type.featOkTst && ((Gene_or_Genome_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Gene_or_Genome");
  ...
  public String getType_feature() {
    if (Gene_or_Genome_Type.featOkTst && ((Gene_or_Genome_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.com.ontotext.s4.api.types.sbt.Gene_or_Genome");
