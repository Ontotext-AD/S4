  ...
  */  
  ...
  public String getRule1() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_rule1 == null)
      jcasType.jcas.throwFeatMissing("rule1", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getRule2() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_rule2 == null)
      jcasType.jcas.throwFeatMissing("rule2", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getType_feature() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getKind() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_kind == null)
      jcasType.jcas.throwFeatMissing("kind", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getRule() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_rule == null)
      jcasType.jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getString() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getLength() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_length == null)
      jcasType.jcas.throwFeatMissing("length", "com.ontotext.s4.api.uima.types.twitie.URL");
  ...
  public String getNormalized() {
    if (URL_Type.featOkTst && ((URL_Type)jcasType).casFeat_normalized == null)
      jcasType.jcas.throwFeatMissing("normalized", "com.ontotext.s4.api.uima.types.twitie.URL");
