...
package com.ontotext.s4.api.components;
...
public class ComponentConfigurationParameters {
     ...
     */
    public ComponentConfigurationParameters withConfigParameter(String parameterName, String parameterValue) {
    ...
    public Object[] getParametersArray() {
        ...
        int idx = 0;
        for (Map.Entry<String, String> pair : parameters) {
