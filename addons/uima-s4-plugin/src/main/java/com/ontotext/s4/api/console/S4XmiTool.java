...
public class S4XmiTool {
    ...
    protected static class CommandLineParams {
		...
		@Parameter(names = {"-u", "--server-url"}, required = true, description = "URL of S4 services")
	...
	private static final String USAGE_DESC = String.format("Instantiate a basic pipeline " +
			"using uimaFIT which calls S4 text analytics services " +
            "and translates them to native UIMA  datastructures" +
            "reads items from an item list and writes the " +
	...
	public static void main(String[] args) throws IOException, UIMAException, SAXException {
        ...
        //runPipeline(S4Endpoints.TWITIE, "s4nfnim4rnmt", "ukrb34e2feea31l", "src/main/resources/docs", "src/main/resources/desc");
	}
