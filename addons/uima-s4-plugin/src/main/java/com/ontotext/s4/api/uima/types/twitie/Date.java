  ...
  */  
  ...
  public String getRule1() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_rule1 == null)
      jcasType.jcas.throwFeatMissing("rule1", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getRule2() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_rule2 == null)
      jcasType.jcas.throwFeatMissing("rule2", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getType_feature() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getKind() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_kind == null)
      jcasType.jcas.throwFeatMissing("kind", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getRule() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_rule == null)
      jcasType.jcas.throwFeatMissing("rule", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getString() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getLength() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_length == null)
      jcasType.jcas.throwFeatMissing("length", "com.ontotext.s4.api.uima.types.twitie.Date");
  ...
  public String getNormalized() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_normalized == null)
      jcasType.jcas.throwFeatMissing("normalized", "com.ontotext.s4.api.uima.types.twitie.Date");
