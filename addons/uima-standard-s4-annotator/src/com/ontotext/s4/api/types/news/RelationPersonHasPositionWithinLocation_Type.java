...
public class RelationPersonHasPositionWithinLocation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getOrganization1Str(int addr) {
      ...
      jcas.throwFeatMissing("organization1Str", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getOrganizationUri(int addr) {
      ...
      jcas.throwFeatMissing("organizationUri", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getOrganization1Uri(int addr) {
      ...
      jcas.throwFeatMissing("organization1Uri", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getRelType(int addr) {
      ...
      jcas.throwFeatMissing("relType", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getOrganizationStr(int addr) {
      ...
      jcas.throwFeatMissing("organizationStr", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
  ...
  public String getQuotationStr(int addr) {
      ...
      jcas.throwFeatMissing("quotationStr", "com.ontotext.s4.com.ontotext.s4.api.types.news.RelationPersonHasPositionWithinLocation");
