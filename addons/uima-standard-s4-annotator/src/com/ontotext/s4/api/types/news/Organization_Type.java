...
public class Organization_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getOrganization1Str(int addr) {
      ...
      jcas.throwFeatMissing("organization1Str", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getOrganizationUri(int addr) {
      ...
      jcas.throwFeatMissing("organizationUri", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getOrganization1Uri(int addr) {
      ...
      jcas.throwFeatMissing("organization1Uri", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getRelType(int addr) {
      ...
      jcas.throwFeatMissing("relType", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getRule(int addr) {
      ...
      jcas.throwFeatMissing("rule", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getString(int addr) {
      ...
      jcas.throwFeatMissing("string", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getClass_feature(int addr) {
      ...
      jcas.throwFeatMissing("class_feature", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getInst(int addr) {
      ...
      jcas.throwFeatMissing("inst", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getType_feature(int addr) {
      ...
      jcas.throwFeatMissing("type_feature", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getOrganizationStr(int addr) {
      ...
      jcas.throwFeatMissing("organizationStr", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getAbbrevUri(int addr) {
      ...
      jcas.throwFeatMissing("abbrevUri", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getAbbrevStr(int addr) {
      ...
      jcas.throwFeatMissing("abbrevStr", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
  ...
  public String getQuotationStr(int addr) {
      ...
      jcas.throwFeatMissing("quotationStr", "com.ontotext.s4.com.ontotext.s4.api.types.news.Organization");
