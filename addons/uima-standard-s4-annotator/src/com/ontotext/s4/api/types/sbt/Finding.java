 ...
 * @generated */
public class Finding extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Finding.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Finding() {/* intentionally empty block */}
   ...
   */
  public Finding(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Finding(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
  ...
  /** getter for string - gets Feature <string> for type <Finding>
   * @generated
   * @return value of the feature 
   */
  public String getString() {
    if (Finding_Type.featOkTst && ((Finding_Type)jcasType).casFeat_string == null)
      jcasType.jcas.throwFeatMissing("string", "com.ontotext.s4.com.ontotext.s4.api.types.sbt.Finding");
  ...
  /** getter for class_feature - gets Feature <class_feature> for type <Finding>
   * @generated
   * @return value of the feature 
   */
  public String getClass_feature() {
    if (Finding_Type.featOkTst && ((Finding_Type)jcasType).casFeat_class_feature == null)
      jcasType.jcas.throwFeatMissing("class_feature", "com.ontotext.s4.com.ontotext.s4.api.types.sbt.Finding");
  ...
  /** getter for inst - gets Feature <inst> for type <Finding>
   * @generated
   * @return value of the feature 
   */
  public String getInst() {
    if (Finding_Type.featOkTst && ((Finding_Type)jcasType).casFeat_inst == null)
      jcasType.jcas.throwFeatMissing("inst", "com.ontotext.s4.com.ontotext.s4.api.types.sbt.Finding");
  ...
  /** getter for type_feature - gets Feature <type_feature> for type <Finding>
   * @generated
   * @return value of the feature 
   */
  public String getType_feature() {
    if (Finding_Type.featOkTst && ((Finding_Type)jcasType).casFeat_type_feature == null)
      jcasType.jcas.throwFeatMissing("type_feature", "com.ontotext.s4.com.ontotext.s4.api.types.sbt.Finding");
